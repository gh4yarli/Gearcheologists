...
@Autonomous(name = "RedGoal_V3_Localized_Bkup")
@SuppressWarnings({"unused", "CommentedOutCode", "RedundantSuppression"})
public class RedGoal_V3_Localized_Bkup extends Auto_CommonFunctions {
    ...
    private void thirdShot() {
        ...
        Action path = mecanumDrive.actionBuilder(pose)
                .splineToLinearHeading(new Pose2d(-25, -40, Math.toRadians(-90)), Math.toRadians(-84))
                .lineToY(-75)
                .lineToY(-61)
                .setReversed(true)
