...
public class test extends M3_CommonFunctions {
    ...
    private void secondShot(@NonNull MecanumDrive mecanumDrive){
        ...
        .splineTo(new Vector2d(-34, -30), Math.toRadians(-90))
                .lineToY(-63)
                //.lineToY(-40)
                .splineToLinearHeading(new Pose2d(-50, -12, Math.toRadians(-27.5)), Math.toRadians(-27.5))
                .build();
