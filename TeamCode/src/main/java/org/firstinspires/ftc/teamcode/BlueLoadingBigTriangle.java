...
@Autonomous(name = "BlueLoadingBigTriangle", preselectTeleOp = "MecanumTeleOp")
@SuppressWarnings({ "unused" })
public class BlueLoadingBigTriangle extends Auto_CommonFunctions {
    ...
    private void secondShot() {
        ...
        double yTarget = isBlueAlliance ? 55 : -58;
